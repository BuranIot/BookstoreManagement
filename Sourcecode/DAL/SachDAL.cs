...
namespace BookstoreManagement.DAL
{
    public class SachDAL
    {
        ...
        private SachDTO MapRow(SqliteDataReader r) => new SachDTO
        {
        ...
        public List<SachDTO> GetAll()
        {
            ...
            using (var cmd  = new SqliteCommand(BASE_SQL + " ORDER BY s.TenSach", conn))
        ...
        public void TruTonKho(string maSach, int soLuong, SqliteConnection conn, SqliteTransaction tran)
        {
            const string sql = @"
